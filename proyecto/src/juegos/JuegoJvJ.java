...
//clase donde se realiza el juego
public class JuegoJvJ{ 
  ...
  //constructor
  public JuegoJvJ(String name1, String name2){
...
////////////////////////////////////////// aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaquiiiiii
  ...
  private void guardarGanadorEnArchivo(String nombreGanador) {
    try {
        ...
        FileWriter fileWriter = new FileWriter("JuegoJvJ.txt", true);
  ...
  /**
  *
  *@return nos sirve para identificar si sigue el juego o acabo
  *
  */
  ...
  *
  *
  *metodo para imprimir las fichas que ya han sido colocadas en la mesa
  */
  ...
  *@param jugador
  *@param jugador2
  *Nos sirven para definir quien tira primero, en base a sus fichas que posee cada uno, puesto que se busca quien tiene la mula mas grande 
  *
  */
  ...
  /**
  *
  *Metodo donde se llaman a todas las funciones para que funcione adecuadamente el juego
  *Ademas de aplicar los hilos, y llamarlos por medio de run()
  *
  */
  public void jugar(){
    this.crearFichas();
